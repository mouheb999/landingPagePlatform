...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "website",
      siteName: "HYPE FITNESS",
      locale: locale === "ar" ? "ar_TN" : "en_US",
      title: t("ogTitle"),
      description: t("ogDescription"),
      url: locale === "ar" ? "/" : `/${locale}`,
      images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "HYPE FITNESS" }],
    },
    twitter: {
...
export default async function LocaleLayout({
  ...
  return (
    <html lang={locale} dir={dir} className={`${cairo.variable} ${saira.variable} ${tajawal.variable}`}>
