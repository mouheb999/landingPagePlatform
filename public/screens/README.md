...
Until a file exists the section shows a styled placeholder in its place — the
same convention `MediaCard` uses — so the page is never broken by a missing
screenshot. Nothing to wire up: add the file and it appears.
